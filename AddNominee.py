...
class Ui_AddNominee(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(200, 130, 111, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(200, 240, 151, 21))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Adding Nominee"))
        self.label.setText(_translate("Dialog", "Adding Nominee"))
        self.label_2.setText(_translate("Dialog", "Nominee Name"))
        self.label_3.setText(_translate("Dialog", "Symbol Name"))
